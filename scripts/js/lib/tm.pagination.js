...
define(['angular'],function(angular){
    ...
    return {
        ...
        template: '<div class="page-list">' +
            ...
            '每页 <select ng-model="conf.itemsPerPage" ng-options="option for option in conf.perPageOptions " ng-change="changeItemsPerPage()"></select> 条' +
        ...
        link: function(scope, element, attrs){
            ...
            scope.$watch(function(){
                var newValue = scope.conf.currentPage + " " + scope.conf.itemsPerPage+ " " + scope.conf.totalItems
                return newValue;
            }, getPagination);
